package com.seen.tests.mileclonempesa_android_sdk;
...
import com.seen.tests.mileclonempesa.Mode;
import com.seen.tests.mileclonempesa.Mpesa;
import com.seen.tests.mileclonempesa.interfaces.AuthListener;
import com.seen.tests.mileclonempesa.interfaces.MpesaListener;
import com.seen.tests.mileclonempesa.models.STKPush;
import com.seen.tests.mileclonempesa.models.STKPush.Builder;
...
public class MainActivity extends AppCompatActivity implements AuthListener, MpesaListener {
    ...
    public static final String SHARED_PREFERENCES = "com.seen.tests.mileclonempesa_android_sdk";
